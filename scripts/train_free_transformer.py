...
def main(cfg: DictConfig) -> int:
    ...
    train_cfg = TrainConfig(
        ...
        latent_mode=str(cfg.freet.get("latent_mode", "unsupervised")),
        n_personas=int(cfg.freet.get("n_personas", 3)),
        persona_loss_weight=float(cfg.freet.get("persona_loss_weight", 1.0)),
